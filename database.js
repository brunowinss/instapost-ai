...
async function initDB() {
  if (isPostgres) {
    ...
    try {
      ...
      openFn = sqliteLib.open;
    } catch (e) {
      throw new Error(
        'SQLite não está disponível e DATABASE_URL não está configurado. ' +
        'Em produção (Render), defina a variável de ambiente DATABASE_URL com a URL do PostgreSQL. ' +
